...
bintsline[24] = None
pl.plot(bintsdisplay[24:48], 'ro', label = '1996-1997')
pl.plot(bintsline[24:48], 'k', label = None)
pl.xticks( range(len(monthsdisplay)), monthsdisplay)

bintsline[48] = None
pl.plot(bintsdisplay[48:58], 'mo', label = '2009')
pl.plot(bintsline[48:58], 'k', label = None)
pl.xticks( range(len(monthsdisplay)), monthsdisplay)
...
plotpath = '../results/' + 'Goodfigure1' + '.pdf'
pl.savefig(plotpath)
