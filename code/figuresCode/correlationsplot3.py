...
h = open('../../results/CorrectedNewCerrado/Bivariateplots/monthdiff&turnover/Turnover&ClimateDiff(CorrectedNew).csv','rb')
data = csv.reader(h)
...
# save plot and show
plotname = 'Turnover&ClimateDiff(CorrectedNew)'
