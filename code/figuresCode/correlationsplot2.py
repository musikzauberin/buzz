...
h = open('../../results/CorrectedNewCerrado/Bivariateplots/monthlyaverage/AvgClimateCoefficients(CorrectedNew).csv','rb')
data = csv.reader(h)
...
# save plot and show
plotname = 'AvgClimateCoefficients(CorrectedNew)'
