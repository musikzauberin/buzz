...
def plotturnovers(a, b, drya, dryb, weta, wetb, xlabel_str, ylabel_str):
  ...
  plotpath = '../../results/CorrectedNewCerrado/Bivariateplots/monthdiff&turnover/' + plotname + '.pdf'
  pl.savefig(plotpath)
  pl.close()
...
def writenewdata(filename_str, headers, values):
  ...
  pathname = '../../results/CorrectedNewCerrado/Bivariateplots/monthdiff&turnover/' + filename_str + '.csv'
  g = open(pathname, 'wb')
