...
for y in ys:
    pl.plot([-1, 28], [y, y], color='black', alpha=.33, linestyle=':')
...
p1, = host.plot(range(1, 23, 2), avgtemps[intervals[0]:intervals[1]], marker = 'o', color = colordict['Temp'], label = 'Temperature', markeredgewidth=0.5, markeredgecolor=almost_black)
p1, = host.plot(range(1, 23, 2), avgmaxtemps[intervals[0]:intervals[1]], marker = 'o', color = colordict['TempMax'], label = 'Maximum Temperature', markeredgewidth=0.5, markeredgecolor=almost_black)
p2, = par1.plot(range(1, 23, 2), avgtempranges[intervals[0]:intervals[1]], marker = 'o', color = colordict['TempRange'], label = 'Temperature Range', markeredgewidth=0.5, markeredgecolor=almost_black)
host.set_xlim(-1, 28)
# axes = pl.gca()
# ymin, ymax = axes.get_ylim()
# xmin, xmax = axes.get_xlim()
...
host.set_ylabel(r"Temperature / $^\circ$C")
par1.set_ylabel("Temperature Range")
p1, = host.plot(range(1, 23, 2), difftemps[intervals[0]:intervals[1]], marker = 'o', color = colordict['Temp'], label = 'Temperature', markeredgewidth=0.5, markeredgecolor=almost_black)
p1, = host.plot(range(1, 23, 2), diffmaxtemps[intervals[0]:intervals[1]], marker = 'o', color = colordict['TempMax'], label = 'Maximum Temperature', markeredgewidth=0.5, markeredgecolor=almost_black)
p2, = par1.plot(range(1, 23, 2), difftempranges[intervals[0]:intervals[1]], marker = 'o', color = colordict['TempRange'], label = 'Temperature Range', markeredgewidth=0.5, markeredgecolor=almost_black)
host.set_xlim(-1, 28)
# axes = pl.gca()
# ymin, ymax = axes.get_ylim()
# xmin, xmax = axes.get_xlim()
...
plotpath = '../../results/CorrectedNewCerrado/Timeplots/' + 'Climate2(CorrectedNew)' + '.pdf'
pl.savefig(plotpath)
