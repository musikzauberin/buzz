...
def monthlyunique(startofmonths2, noofmonths, plants, bees):
...
[monthlybees, monthlyplants] = monthlyunique(startofmonths2, noofmonths, plants, bees)
...
def calc_specturnover(startofmonths2, aplantlist, bplantlist, cplantlist, abeelist, bbeelist, cbeelist):
  ...
  specturnovers = [0] * (len(startofmonths2) - 1)
  for i in range(len(monthlyplants) - 1):
...
specturnovers = calc_specturnover(startofmonths2, aplantlist, bplantlist, cplantlist, abeelist, bbeelist, cbeelist)
...
[osturnovers, stturnovers] = calc_osstturnover(startofmonths2, noofmonths, bees, commonbees, plants, commonplants)
