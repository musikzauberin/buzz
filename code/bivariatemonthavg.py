...
'''Plot bivariate graph and spearman coefficent (climate bet months avg)'''
...
turnoverset = [avgprecips, avgtemps, avgmaxtemps, avgtempranges, avghumids]
turnoverxset = [[avgtemps, avgmaxtemps, avgtempranges, avghumids], \
[avgmaxtemps, avgtempranges, avghumids], \
[avgtempranges, avghumids], \
[], []]
wetturnoverset = [wetavgprecips, wetavgtemps, wetavgmaxtemps, wetavgtempranges, wetavghumids]
dryturnoverset = [dryavgprecips, dryavgtemps, dryavgmaxtemps, dryavgtempranges, dryavghumids]
turnoversetlabel = ['AvgPrecips', 'AvgTemps', 'AvgMaxTemps', 'AvgTempRanges', 'AvgHumids']
