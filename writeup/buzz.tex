...
\begin{align*}
	& \textnormal{Whittaker's dissimilarity measure: } & \beta_{W} & = \frac{a + b + c}{(2a + b + c)/2} - 1 \\
	 ...
	 &\textnormal{Dissimilarity of interactions due to species turnover: } & \beta_{st} & = 0.89474 - 0.33333 & = 0.561 \\
	 \\
	 &\textnormal{Species turnover: } & \beta_{S} & = \frac{2 + 1 + 1}{(2*(2) + 1 + 1)/2} - 1 & = 0.333\\
	 &\textnormal{Bee turnover: } & \beta_{Bee} & = \frac{2 + 1 + 1}{(2*(2) + 1 + 1)/2} - 1 & = 0.333\\
	 &\textnormal{Plant turnover: } & \beta_{Plant} & = \frac{3 + 8 + 8}{(2*(3) + 10 + 8)/2} - 1 & = 0.727\\
