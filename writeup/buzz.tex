...
\\
Understanding the drivers of interaction turnover can provide new insight into the impact of climate change on plant-pollinator networks. Increases in global temperature result in drastic shifts in flowering, which can lead to disruptions of spatial and temporal co-occurrences of flowers and pollinators in temperature regions~\citep{Schweiger2010}. However, in tropical regions, where most pollinators are active for periods longer than the flowering timescale of most individual plant species~\citep{Biesmeijer2006}, the impact of rising temperatures and harsher weather conditions on pollination services remain unknown. By investigating the factors that drive interaction turnover at a tropical site, we can better understand, at a finer resolution, how plant-pollinator interactions will be affected by climate change in the near future and be better informed when drawing up counter measures to maintain pollination services~\citep{Schweiger2010}. \\
\\
...
\\
Besides being a highly seasonal habitat, the Cerrado acts as an important model system for studies on temporal plant-pollinator networks as it sustains a significant percentage of the Neotropical angiosperm diversity. The Cerrado is the second largest tropical biome in South America and is viewed as one of the most threatened tropical ecosystems due to excessive deforestation and poor conservation policies, which have already caused more than 50 \% of its area to be degraded~\citep{Myers2000, KLINK2005}. Unfortunately, data of the region is scarce and the ecological networks of this region are poorly understood.\\
\\
In this study, I propose a framework for investigating how climatic factors can influence interaction turnover using two dataset collected in the Cerrado. Firstly, differences between subsequent temporal networks, also known as $\beta$-diversity, was quantified using a number of $\beta$-dissimilarity measures, which reflect interaction, species, plant and bee changes over time. Correlations between $\beta$-dissimilarity measures were then investigated and compared to theoretical and previously published trends. Lastly, to provide a macroscopic view, relationships between climatic factors and temporal dissimilarity in plant communities were examined. \\
\\
...
Interaction turnover, $\beta_{int}$, is consistently high, ranging from 0.747 to 1~(\hyperref[table: turnovers]{Table S\ref{table: turnovers}}). \\
\\
...
\begin{figure}[H]
  \centering
    ...
    \captionof{figure}{\setstretch{1.3} Monthly bee pollinator networks from Jun 1995 to Jun 1997 (BBG site) and from Oct 2008 to Sep 2009 (IBGE site).}
    \label{fig: networks}
\end{figure}
	\vspace*{\fill}
\end{landscape}
...
consistently high turnover, higher than in caradona
probably becos within season, temperate, lower plant turnover, week to week
but maybe due to inaccurate sampling
species turnover drives int turnover(shown before)
plant turnover drives int turnover expected 
temperature drives expected
surprisingly precipitation does not 

Limitations: Correlation does not relate to causation, but diff to conduct such empirical experiments, diff to hold variables constant \\
small dataset, 
Future Research: more data-> databank, 
artic temperature comparisons
across sites comparisons \\
...
\begin{figure}[h]
  \centering
    \includegraphics[width=185mm, height = 68mm]{Climate(new).pdf} \\
    \captionof{figure}{\setstretch{1.3} Monthly bee pollinator networks from Jun 1995 to Jun 1997 (BBG site) and from Oct 2008 to Sep 2009 (IBGE site).}
    \label{fig: climatetimeplotnew}
\end{figure}
