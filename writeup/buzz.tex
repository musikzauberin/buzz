...
\begin{align*}
	& \textnormal{Whittaker's dissimilarity measure: } & \beta_{W} & = \frac{a + b + c}{(2a + b + c)/2} - 1 \\
	 ...
	 &\textnormal{Dissimilarity of interactions due to species turnover: } & \beta_{st} & = 0.895 - 0.333 & = 0.562 \\
	 \\
	 &\textnormal{Species turnover: } & \beta_{S} & = \frac{2 + 1 + 1}{(2*(2) + 1 + 1)/2} - 1 & = 0.333\\
	 &\textnormal{Plant turnover: } & \beta_{Plant} & = \frac{3 + 10 + 8}{(2*(3) + 10 + 8)/2} - 1 & = 0.75\\
