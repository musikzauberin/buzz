...
$\beta_{st}$ & Dissimilarity of interactions due to species turnover &  & \cite{Poisot2012}  \\
...
\begin{figure}[h]
  \centering
    \includegraphics[width=200mm]{Climate(old)1.pdf} \\
...
\begin{figure}[H]
  \centering
    \includegraphics[width=260mm]{network(old)3.png} \\
    \vspace{0.8cm}
    \includegraphics[width=260mm]{network(new)3.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=260mm]{seasonalnetwork(old)3.png} \\
    \vspace{1cm}
    \includegraphics[width=260mm]{seasonalnetwork(new)3.png}
...
\begin{figure}[H]
  \centering
    ...
    \captionof{figure}{\setstretch{1.3} \textbf{Time series plot of turnover measures from Jun 1995 to Jun 1997 (BBG site).} Interaction turnover, $\beta_{int}$, is surprisingly and consistently high in the Cerrado and is driven by both species turnover, $\beta_{S}$, and plant turnover, $\beta_{Plant}$. ($\beta_{st}$: Dissimilarity of interactions due to species turnover; $\beta_{rw}$: Dissimilarity of interactions between species present in both networks; $\beta_{Bee}$: Bee turnover)}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=240mm]{TimeplotTurnovers(New).pdf} \\
    \captionof{figure}{\setstretch{1.3} \textbf{Time series plot of turnover measures from Oct 2008 to Sep 2009 (IBGE site).} \\ Interaction turnover, $\beta_{int}$, is surprisingly and consistently high in the Cerrado and is driven by both species turnover, $\beta_{S}$, and plant turnover, $\beta_{Plant}$. ($\beta_{st}$: Dissimilarity of interactions due to species turnover; $\beta_{rw}$: Dissimilarity of interactions between species present in both networks; $\beta_{Bee}$: Bee turnover)}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=240mm]{Climate(new)1.pdf} \\
...
\multicolumn{1}{|c|}{\cellcolor[HTML]{EFEFEF}Year} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}Months} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}$\beta_{int}$} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}$\beta_{rw}$} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}$\beta_{st}$} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}$\beta_{S}$} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}$\beta_{Bee}$} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}$\beta_{Plant}$} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}Site} \\ \hline
