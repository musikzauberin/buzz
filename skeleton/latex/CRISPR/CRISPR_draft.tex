...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.6\textwidth]{NLS-Cas9-His_1ststep.png}
...
\begin{minipage}{.50\linewidth}
  ...
  \captionof{figure}{\footnotesize SDS-PAGE of NLS-Cas9-His before and after second IEX. Loaded sample comprises of A5 aliquot from the first IEX. Second IEX separates proteins from the two peaks in the first IEX~(\autoref{fig:NLS-Cas9-His_1stIEX.png}). A1-A8 are collected aliquots from IMAC. A6 and A8 contain purified NLS-Cas9-His from the first and second peak of the chromatogram~(\autoref{fig:NLS-Cas9-His_1ststep.png}). FT: Flowthrough}
